    ...
    <div class="mainslider glide">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('specialists__img'); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus__img1'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus__img2'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus__img3'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"><?php the_field('contacts__title'); ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
